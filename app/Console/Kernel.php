...
final class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule->command('sitemap:generate')->dailyAt('5:00')->appendOutputTo($output);

        // 毎時
        $schedule->command('article:ranking')->hourly()->appendOutputTo($output);
        $schedule->command('article:json')->hourly()->appendOutputTo($output);
