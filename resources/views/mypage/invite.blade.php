        ...
        <div>
            ...
            <div>
                ...
                <form id="generate" action="{{route('mypage.invite')}}" method="POST">
                    ...
                    <input type="text" disabled value="{{route('user.invite',$user->invitation_code)}}" class="v2-input w-full mb-4" />
                    <div class="gap-x-2 flex">
                        <button type="submit" class="v2-button v2-button-lg v2-button-sub js-clipboard" data-text="{{route('user.invite',$user->invitation_code)}}">
                            リンクをコピー
                        </button>
                        <button type="submit" class="v2-button v2-button-lg v2-button-primary">
                            再発行
                        </button>
                        <button type="submit" class="v2-button v2-button-lg v2-button-danger" form="revoke">
                            削除
                        </button>
                    </div>
                    @else
