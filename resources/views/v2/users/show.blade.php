...
<div class="mx-auto max-w-7xl p-6 lg:px-8">
    <div>
        <h2 class="text-4xl font-semibold text-pretty text-gray-900 sm:text-5xl">{{$user->name}}さんの記事</h2>
        <div class="mt-2">
            @include('v2.parts.link', ['url' => route('search', ['userIds' => [$user->id]]), 'title' => 'さらに検索条件を追加する'])
        </div>
    </div>
