...
@endphp
<body>
    <div class="absolute top-0 bottom-0 left-0 right-0 overflow-hidden bg-tertiary py-24 sm:py-32" style="background-blend-mode: multiply;background-image: url('{{ $bgPath }}');">
