...
final class StoreRequestTest extends TestCase
{
    ...
    public static function dataFail(): \Generator
    {
        ...
        yield 'AddonIntroduction 他人の投稿したサムネイルID' => [
            ArticlePostType::AddonIntroduction,
            fn(self $self): array => ['contents' => [
                'thumbnail' => $self->createImageAttachment(User::factory()->create())->id,
            ]],
            'article.contents.thumbnail',
        ];
        ...
        yield 'Page 画像セクションが画像以外' => [
            ...
            fn(self $self): array => ['contents' => ['sections' => [[
                'type' => 'image',
                'id' => $self->createAttachment($self->user)->id,
            ]]]],
            'article.contents.sections.0.id',
        ];
        yield 'Page 画像セクションが他人の投稿したID' => [
            ...
            fn(self $self): array => ['contents' => ['sections' => [[
                'type' => 'image',
                'id' => $self->createAttachment(User::factory()->create())->id,
            ]]]],
            'article.contents.sections.0.id',
        ];
    }
