...
abstract class BaseRequest extends FormRequest
{
    ...
    protected function addonPost(): array
    {
        return [
            ...
            'article.tags.*' => 'required|exists:tags,id',
            'article.contents.thumbnail' => ['nullable', 'exists:attachments,id,user_id,'.Auth::id(), resolve(ImageAttachment::class)],
    ...
    protected function page(): array
    {
        return [
            ...
            'article.contents.sections.*.id' => ['required_if:article.contents.sections.*.type,image', 'exists:attachments,id,user_id,'.Auth::id(), resolve(ImageAttachment::class)],
        ];
    }
