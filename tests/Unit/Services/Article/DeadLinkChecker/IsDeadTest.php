...
final class IsDeadTest extends TestCase
{
    ...
    public function test_ok(): void
    {
        ...
        $this->mock(GetHeadersHandler::class, function (MockInterface $mock): void {
            $mock->expects()->getHeaders('dummy')->once()->andReturn(['Status Code: 200 OK']);
        });
    ...
    public function test_3回失敗でNG(): void
    {
        ...
        Event::fake();
        $this->mock(GetHeadersHandler::class, function (MockInterface $mock): void {
            $mock->expects()->getHeaders('dummy')->times(3)->andReturn(['Status Code: 500 Internal Server Error']);
        });
