<template>
  <div>
    <page-title>認証アプリ</page-title>
    <page-description>
      Portalへアクセス可能な認証クライアント・アクセストークンを管理できます。
    </page-description>

    <page-sub-title>認証クライアント</page-sub-title>
    <page-description>
      Portalへアクセス可能な認証クライアントを作成できます。<br />
