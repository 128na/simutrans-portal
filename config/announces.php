    ...
    [
        ...
        'contents' => [
            'sections' => [
                ...
                ['type' => 'text', 'text' =>
"このサイトはSimutransのアドオンを「プレイヤーが検索しやすく」、
...
※記事を投稿・編集すると自動的に@SimutransPortalのアカウントでツイートが行われます。"],
        ...
        'contents' => [
            'sections' => [
                ['type' => 'text', 'text' =>
"システムをWordPressからLaravelの作成したものに置き換えました。

今回は表示の高速化をメインに構築しました。
機能は以前と大きく変わりませんが出来合いのシステムでは難しかった取得データの最適化、キャッシュを活用して表示速度を上げています。"],
                ['type' => 'caption', 'caption' => "新機能"],
                ['type' => 'text', 'text' =>
"アドオン記事の閲覧数(PV)やダウンロード・DL先ページへの遷移数(CV)をGoogleAnalyticsのようにグラフ表示できる機能を実装しました。
