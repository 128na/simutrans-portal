...
final class StoreRequestTest extends TestCase
{
    ...
    public static function dataFail(): \Generator
    {
        // yield '投稿形式が空' => [
        //     null,
        //     fn (self $self): array => ['post_type' => ''], 'article.post_type',
        // ];
        // yield '不正な投稿形式' => [
        //     null,
        //     fn (self $self): array => ['post_type' => 'test_example'], 'article.post_type',
        // ];
        ...
        //     ArticlePostType::AddonIntroduction,
        //     fn (self $self): array => ['contents' => ['thumbnail' => $self->createImageAttachment($self->user)->id]], 'article.contents.thumbnail',
        // ];
        // yield 'AddonIntroduction 他人の投稿したサムネイルID' => [
        //     ArticlePostType::AddonIntroduction,
        //     fn (self $self): array => ['contents' => ['thumbnail' => $self->createAttachment(User::factory()->create())->id]], 'article.contents.thumbnail',
        // ];
