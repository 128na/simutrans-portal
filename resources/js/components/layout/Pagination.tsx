...
const baseClass =
  "flex items-center justify-center px-4 h-10 text-secondary bg-white border border-muted";
        ...
        <li>
          <button
            className={twMerge(
              ...
              current === 1 ? "" : "hover:bg-muted cursor-pointer"
            )}
        ...
        <li>
          <button
            className={twMerge(
              baseClass,
              "rounded-e-lg",
              current === total ? "" : "hover:bg-muted cursor-pointer"
            )}
