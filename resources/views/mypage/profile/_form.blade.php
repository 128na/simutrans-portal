<div class="form-group">
    <label><span class="badge badge-secondary mr-1">@lang('Optional')</span>@lang('Avatar image') </label>
    <div class="mb-2">
...
<div class="form-group">
    <label for="name"><span class="badge badge-danger mr-1">@lang('Required')</span>@lang('Name')</label>
    <input type="text" class="form-control" id="name" name="name" placeholder="Name" value="{{ old('name', $user->name ?? '') }}">
</div>

<div class="form-group">
    <label for="email"><span class="badge badge-danger mr-1">@lang('Required')</span>@lang('Email')</label>
...
<div class="form-group">
    <label for="twitter"><span class="badge badge-secondary mr-1">@lang('Optional')</span>@lang('Twitter ID')</label>
