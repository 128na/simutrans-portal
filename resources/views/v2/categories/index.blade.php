...
<div class="mx-auto max-w-7xl p-6 lg:px-8">
    <div>
        <h2 class="text-4xl font-semibold text-pretty text-gray-900 sm:text-5xl">Pak別アドオン一覧</h2>
        <p class="mt-2 text-lg/8 text-gray-600">
            {{$meta['description']}}<br>
            記載以外のPaksetやカテゴリは @include('v2.parts.link', ['url' => route('search'), 'title' => '検索']) から探せます。
        </p>
    </div>
