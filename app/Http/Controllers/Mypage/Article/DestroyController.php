...
class DestroyController extends Controller
{
     ...
     * 記事を削除
     */
    #[OA\Delete(path: '/api/v2/articles/{article}', description: '指定された記事を削除します（論理削除）', summary: '記事の削除', security: [['sanctum' => []]], tags: ['Articles'], parameters: [
        new OA\Parameter(
            name: 'article',
            description: '記事ID',
            in: 'path',
        ...
        new OA\Response(
            ...
            content: new OA\JsonContent(
                properties: [
                    new OA\Property(property: 'article_id', description: '削除された記事ID', type: 'integer', example: 1),
                ]
            )
        ),
        new OA\Response(
