...
final class GenerateTopOrderByPublishedAt extends BaseGenerator
{
    ...
    protected function getJsonData(): array
    {
        ...
        return [
            'paks' => [
                'pak128japan' => ArticleResource::collection($this->articleService->paginateByCategory(
                    CategoryType::Pak,
                    '128-japan',
                    true,
                    ArticleService::ORDER_BY_PUBLISHED_AT,
                )),
                'pak128' => ArticleResource::collection($this->articleService->paginateByCategory(
                    CategoryType::Pak,
                    '128',
                    true,
                    ArticleService::ORDER_BY_PUBLISHED_AT,
                )),
                'pak64' => ArticleResource::collection($this->articleService->paginateByCategory(
                    CategoryType::Pak,
                    '64',
                    true,
                    ArticleService::ORDER_BY_PUBLISHED_AT,
                ...
                'pages' => ArticleResource::collection($this->articleService->paginatePages(
                    true,
                    ArticleService::ORDER_BY_PUBLISHED_AT,
                )),
                'announces' => ArticleResource::collection($this->articleService->paginateAnnouces(
                    true,
                    ArticleService::ORDER_BY_PUBLISHED_AT,
                )),
            ],
