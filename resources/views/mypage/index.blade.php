            ...
            <table class="border-collapse whitespace-nowrap">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2">@include('components.ui.link', ['url' => route('mypage.redirects'), 'title' => 'リダイレクト設定'])</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2" rowspan="2">@include('components.ui.link', ['url' => route('mypage.analytics'), 'title' => 'アナリティクス'])</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2">@include('components.ui.link', ['url' => route('mypage.tags'), 'title' => 'タグ編集'])</td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <table class="border-collapse whitespace-nowrap">
                <tbody>
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2" rowspan="2">@include('components.ui.link', ['url' => route('mypage.profile'), 'title' => 'プロフィール編集'])</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2">@include('components.ui.link', ['url' => route('mypage.two-factor'), 'title' => '設定'])</td>
                    </tr>
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2">@include('components.ui.link', ['url' => route('mypage.invite'), 'title' => '設定'])</td>
                    </tr>
                    <tr>
                        ...
                        <td class="border border-gray-300 px-4 py-2">@include('components.ui.link', ['url' => route('mypage.login-histories'), 'title' => 'ログイン履歴'])</td>
                    </tr>
