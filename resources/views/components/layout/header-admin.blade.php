...
<header class="bg-white">
    <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 border-muted">
        ...
        <el-popover-group class="hidden lg:flex lg:gap-x-12">
            <a href="{{route('index')}}" class="text-sm/6 font-semibold text-primary">トップページ</a>
            ...
            <div class="relative">
                ...
                <el-popover id="desktop-menu-article" anchor="bottom" popover class="w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg outline-1 outline-primary/5 transition transition-discrete [--anchor-gap:--spacing(3)] backdrop:bg-transparent open:block data-closed:translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in">
                    <div class="p-4">
            ...
            <div class="relative">
                ...
                <el-popover id="desktop-menu-user" anchor="bottom" popover class="w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg outline-1 outline-primary/5 transition transition-discrete [--anchor-gap:--spacing(3)] backdrop:bg-transparent open:block data-closed:translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in">
                    <div class="p-4">
                        <div class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm/6 hover:bg-gray-50">
                            <div class="flex-auto">
            ...
            <a href="{{config('app.support_site_url')}}" class="text-sm/6 font-semibold text-primary" target="_blank" rel="noopener">サイトの使い方</a>
                    ...
                    <div class="mt-6 flow-root">
                        <div class="-my-6 divide-y divide-secondary/10">
                            <div class="space-y-2 py-6">
                                <a href="{{route('index')}}" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-primary hover:bg-gray-50">トップページ</a>
                                ...
                                <a href="{{route('mypage.articles.index')}}" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-primary hover:bg-gray-50">一覧</a>
                                <a href="{{route('mypage.articles.create')}}" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-primary hover:bg-gray-50">作成</a>
                                <a href="{{route('mypage.analytics')}}" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-primary hover:bg-gray-50">アクセス解析</a>
                            ...
                            <div class="space-y-2 py-6">
                                ...
                                <a href="{{config('app.support_site_url')}}" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-primary hover:bg-gray-50" target="_blank" rel="noopener">サイトの使い方</a>
                            </div>
                            <div class="py-6">
                                <form action="{{route('logout')}}" method="POST">
                                    @csrf
